			...
			<div
				...
				<div style={{display: 'flex', alignItems: 'center', gap: '24px'}}>
					<div
						...
						<img
							src={BRAND_EYES_DATA_URI}
							width={132}
							height={57}
						/>
					</div>
					<div style={{display: 'flex', color: '#ffffff', fontSize: 32, letterSpacing: 6}}>
						{'TOKEN ASSETS'}
					</div>
				</div>
				<div
					...
					<div style={{display: 'flex', fontSize: 100, fontWeight: 700, lineHeight: 1.05}}>
						{'One CDN for'}
					</div>
					<div style={{display: 'flex', fontSize: 100, fontWeight: 700, lineHeight: 1.05}}>
						{'every token'}
